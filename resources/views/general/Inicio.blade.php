...
@section('contenido')
    ...
    <section class="w-100" style="background-color: transparent; padding: 0; margin: 0;">
        <div class="container-fluid p-0 m-0">
            <img src="{{ asset('imagenes/logos/1_LOGO_PRINCIPAL_con_titulo_ROJO.jpg') }}" alt="Logo Estudios de la Humanidad"
                class="img-fluid w-100" style="height: 50px; object-fit: contain; display: block;">
        </div>
    </section>
        ...
        <div class="carousel-inner">
            @foreach ($publicaciones as $key => $pub)
                <div class="carousel-item {{ $key == 0 ? 'active' : '' }}">
                    <div class="w-100"
                        style="background-color:#F2B81B; min-height:60vh; display:flex; justify-content:center; align-items:center;">
                        <div class="row w-100 justify-content-center align-items-center"
                            style="max-width:1200px; padding:40px; border-radius:15px;">
    ...
    <section class="d-flex flex-wrap position-relative text-center" style="height:100vh; background-color:#f8f5ec;">
        ...
        <!-- Líneas divisorias -->
        <div style="position:absolute; top:50%; left:0; width:100%; height:2px;  transform:translateY(-50%); z-index:1;">
        </div>
        <div style="position:absolute; left:50%; top:0; width:2px; height:100%;  transform:translateX(-50%); z-index:1;">
        </div>

        <!-- Cuadro 1 -->
        <div class="col-6 d-flex flex-column justify-content-center align-items-center p-4 quadrant"
    ...
    <section class="timeline-section py-5">
        <div class="container">
            ...
            <div class="timeline position-relative">
                ...
                <!-- Item 1 -->
                <div class="timeline-item" data-aos-duration="500" data-aos="fade-up" data-aos-easing="ease-in-sine">
                    <div class="timeline-content bg-white shadow-sm rounded p-4">
                        <h5 class="fw-bold" style="color:#E44942;">1994</h5>
                        <p>Nace <em>Estudios del Hombre</em>, como una revista especializada en Antropología, Arqueología,
                            Historia y Etnografía..</p>
                    </div>
                </div>
                ...
                <div class="timeline-item" data-aos-duration="500" data-aos="fade-up" data-aos-easing="ease-in-sine">
                    <div class="timeline-content bg-white shadow-sm rounded p-4">
                        ...
                        <p>La revista comenzó a ser una publicación temática a partir del número 5 con el tema <em>Ensayos
                                sobre el tiempo</em>.</p>
                    </div>
                </div>
                ...
                <div class="timeline-item" data-aos-duration="500" data-aos="fade-up" data-aos-easing="ease-in-sine">
                    <div class="timeline-content bg-white shadow-sm rounded p-4">
                        ...
                        <p>La publicación se gestionó como una colección de libros y se crearon las series Antropología,
                            Antropología de la alimentación, Arqueología, Historia, Interfaces y Ensayos.</p>
                    </div>
                </div>
                ...
                <div class="timeline-item" data-aos-duration="500" data-aos="fade-up"  data-aos-easing="ease-in-sine">
                    <div class="timeline-content bg-white shadow-sm rounded p-4">
                        ...
                        <p><em>Estudios de la humanidad</em> actualiza el nombre de la colección a <em>Estudios de la
                                humanidad</em>.</p>
                    </div>
                </div>
            ...
            <div class="row justify-content-center text-center">
                <div class="col-lg-9">
                    ...
                    <p class="text-muted" style="text-align: justify; line-height: 1.8;">
                        Las temáticas abordadas en las publicaciones de la Colección <strong>Estudios de la
                            Humanidad</strong> buscan aportar conocimientos sobre el ser humano y su incidencia en el mundo
                        desde una perspectiva humanística y de las ciencias sociales, sin limitación de marco temporal y
                        espacial. <br> <br>Se trata de textos que examinan, desde enfoques teóricos y metodológicos diversos
                        y transdisciplinarios, los fenómenos de las diversas expresiones de la cultura material y simbólica
                        de la Humanidad; se abordan también aspectos de la sociedad, de la historia, la etnohistoria y la
                        etnografía del Occidente de México, de sus agentes individuales y colectivos, y sus movimientos
                        sociales.
                    </p>
                    {{-- </div> --}}
                </div>
    ...
    <section class="container my-5">
        <h3 class="fw-bold mb-3"
            style="display: inline-block; border-bottom: 1px solid #F2B81B; padding-bottom: 0.25rem;">Comité Editorial</h3>
        ...
        <button class="btn btn-outline-dark" type="button" data-bs-toggle="collapse" data-bs-target="#comiteCollapse"
            aria-expanded="false" aria-controls="comiteCollapse">
        ...
        <div class="collapse mt-3" id="comiteCollapse">
            <ul class="list-unstyled">
                @foreach ($comite as $miembro)
                    @if (!Str::contains(strtolower($miembro->nombre), 'chloé'))
                        {{-- evita repetir a la directora --}}
                        <li class="mb-2">
    ...
    <section class="container">
        <h3 class="fw-bold mb-3"
            style="display: inline-block; border-bottom: 1px solid #F2B81B; padding-bottom: 0.25rem;"">Lineamientos y
            Normas</h3>
        {{-- <div class="row g-4">
    <div class="col-md-6">
      <div class="card border-0 shadow-sm">
        ...
        <a href="{{ asset('pdfs/2025_Normas_actualizadas_guía_de_autores_y_coordinadores. EDH.docx.pdf') }}" download
            class="btn text-white" style="background-color:#F2B81B;">
            Descargar PDF
        </a>
        {{-- </div>
      </div>
    ...
    <section class="container mb-5">
        <h3 class="fw-bold mb-3"
            style="display: inline-block; border-bottom: 1px solid #F2B81B; padding-bottom: 0.25rem;"">Propuestas de
            números</h3>
        <p class="text-muted">
            Si cuentas con un producto de investigación que se alinee con los principios de la colección Estudios de la
            Humanidad,
            puedes enviarlo para evaluación del comité editorial mediante el siguiente formato.
        </p>
        <a href="{{ asset('pdfs/EDH_Formato_Presentacion_Propuesta_2025.docx') }}" download class="btn text-white"
