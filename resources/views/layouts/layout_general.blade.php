...
<body style="background-color: #FFFFFF;">
    ...
    <nav class="navbar navbar-expand-lg navbar-light"
        style="background-color: #EDE4CA; font-family: 'Michroma', sans-serif;">

        <div class="container">

            <!-- Logo e inicio -->
            <a class="navbar-brand d-flex align-items-center" href="{{ route('general.inicio') }}">
                <img src="{{ asset('imagenes/logos/1A_Logo_blanco_circulo_ROJO.png') }}" alt="Logo" width="35"
                    height="35" class="d-inline-block me-2">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarContenido">
                ...
                {{ request()->routeIs('general.coleccion') && request()->route('tipo') == $tipo->id ? 'fw-bold' : '' }}"
                                    href="{{ route('general.coleccion', $tipo->id) }}" style="color: #4a4a4a;">
                                    {{ $tipo->nombre }}
                                </a>
                            </li>
                        @endforeach
        ...
        <div class="container py-4 text-center">
            ...
            <div class="mb-4">
                <img src="{{ asset('imagenes/logos/1_LOGO_PRINCIPAL_con_titulo_ROJO.png') }}"
                    alt="Logo principal Estudios Humanidad" style="max-width: 300px; height: auto;">
            </div>
            ...
            <div class="row text-center text-md-start justify-content-center">
                ...
                <p class="small mb-2">edh.cucsh@academicos.udg.mx</p> --}}
                    ...
                    <img src="{{ asset('imagenes/logos/1A_Logo_blanco_circulo_ROJO.png') }}"
                        alt="Logo circular Estudios Humanidad" style="width: 40px; height: 40px; margin-top: 15px;">
                </div>
